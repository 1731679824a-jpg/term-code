...
from termcode.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from termcode.tools.bash import Bash
    from termcode.tools.edit_file import EditFile
    from termcode.tools.file_state_cache import FileStateCache
    from termcode.tools.glob import Glob
    from termcode.tools.grep import Grep
    from termcode.tools.read_file import ReadFile
    from termcode.tools.write_file import WriteFile
