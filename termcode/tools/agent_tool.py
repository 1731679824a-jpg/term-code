...
from termcode.tools.base import Tool, ToolResult
...
if TYPE_CHECKING:
    ...
    from termcode.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from termcode.agents.fork import ForkError, build_forked_messages
        from termcode.agents.parser import AgentDef
        from termcode.agents.tool_filter import resolve_agent_tools
        from termcode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from termcode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from termcode.agents.fork import ForkError, build_forked_messages
        from termcode.agents.parser import AgentDef
        from termcode.agents.tool_filter import build_teammate_tools
        from termcode.agent import Agent as AgentClass
        from termcode.conversation import ConversationManager
        from termcode.permissions import (
            DangerousCommandDetector,
        ...
        from termcode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from termcode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from termcode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from termcode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from termcode.client import create_client
        from termcode.config import ProviderConfig
