'''
管理多个 MCP 服务器的生命周期，统一注册和关闭
'''
from __future__ import annotations

import logging

from termcode.config import MCPServerConfig
from termcode.mcp.client import MCPClient
from termcode.mcp.tool_wrapper import MCPToolWrapper
