...
from termcode.conversation import (
    ConversationManager,
    Message,
    ToolResultBlock,
    estimate_tokens,
)
from termcode.serialization import build_messages
...
SESSION_SUBDIR = ".termcode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from termcode.tools.base import StreamEnd, StreamEvent, TextDelta
