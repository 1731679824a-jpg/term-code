...
from termcode.commands import (
    CommandContext,
    CommandRegistry,
    complete,
    parse_command,
)
from termcode.commands.completion import CompletionPopup
from termcode.commands.handlers import register_all_commands
from termcode.config import MCPServerConfig, ProviderConfig
from termcode.hooks import HookContext, HookEngine, load_hooks
from termcode.conversation import ConversationManager, Message
from termcode.mcp import MCPManager
from termcode.memory import (
    MemoryManager,
    Session,
    SessionManager,
...
from termcode.permissions import (
...
from termcode.agents.task_manager import TaskManager
from termcode.agents.trace import TraceManager
from termcode.agents.notification import inject_task_notifications
from termcode.commands.handlers.tasks import create_tasks_command
from termcode.skills.executor import SkillExecutor
from termcode.skills.loader import SkillLoader
from termcode.commands.handlers.skill_register import register_skill_commands
from rich.text import Text as RichText
from textual.theme import Theme
from termcode.cache import FileCache
from termcode.tools import ToolRegistry, create_default_registry
from termcode.tools.agent_tool import AgentTool
from termcode.tools.ask_user import AskUserEvent, AskUserTool
from termcode.tools.impl.tool_search import ToolSearchTool
from termcode.tools.load_skill import LoadSkill
from termcode.worktree.cleanup import start_stale_cleanup_task
from termcode.worktree.manager import WorktreeManager
from termcode.commands.handlers.worktree import create_worktree_command
from termcode.teammate_tree import TeammateTree
...
_SKIP_DIRS = {".git", "node_modules", ".venv", "__pycache__", ".termcode", "build", ".gradle"}
...
class ChatInput(TextArea):
    ...
    def load_history(self, work_dir: str) -> None:
        self._history_file = Path(work_dir) / ".termcode" / "history"
...
class TermCodeApp(App):
    ...
    def on_mount(self) -> None:
        self.register_theme(_TERMCODE_THEME)
        self.theme = "termcode"
        if len(self.providers) == 1:
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        checker = PermissionChecker(
            ...
            rule_engine=RuleEngine(
                user_rules_path=home / ".termcode" / "permissions.yaml",
                project_rules_path=Path(work_dir) / ".termcode" / "permissions.yaml",
                local_rules_path=Path(work_dir) / ".termcode" / "permissions.local.yaml",
            ),
        ...
        from termcode.filehistory import FileHistory
        ...
        from termcode.tools.exit_plan_mode import ExitPlanModeTool
        ...
        # --- Worktree 系统初始化 ---
        from termcode.config import WorktreeConfig
        ...
        from termcode.tools.enter_worktree import EnterWorktreeTool
        from termcode.tools.exit_worktree import ExitWorktreeTool
        ...
        # --- Agent 团队系统初始化 ---
        from termcode.teams.manager import TeamManager
        from termcode.tools.team_create import TeamCreateTool
        from termcode.tools.team_delete import TeamDeleteTool
        ...
        from termcode.commands.handlers.trace import create_trace_command
        ...
        from termcode.tools.synthetic_output import SyntheticOutputTool
    ...
    async def _prefetch_relevant_memories(self, query: str) -> str:
        ...
        async def selector(system_prompt: str, user_message: str) -> str:
            from termcode.tools.base import StreamEnd, TextDelta
    ...
    async def _show_plan_approval(self) -> None:
        from termcode.plan_dialog import InlinePlanWidget
    ...
    def on_inline_plan_widget_responded(
        ...
        from termcode.plan_dialog import InlinePlanWidget, PlanChoice
    ...
    async def _handle_askuser(self, event: AskUserEvent) -> None:
        from termcode.askuser_dialog import InlineAskUserWidget
    ...
    async def _handle_permission_request(self, request: PermissionRequest) -> None:
        from termcode.permission_dialog import InlinePermissionWidget
