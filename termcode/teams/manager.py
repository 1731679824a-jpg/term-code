...
from termcode.teams.backend_detect import BackendDetectionError, detect_backend
from termcode.teams.mailbox import Mailbox, create_message
...
from termcode.teams.progress import TeammateProgress
from termcode.teams.registry import AgentNameRegistry
from termcode.teams.shared_task import SharedTaskStore
from termcode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from termcode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
