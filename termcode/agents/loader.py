...
PROJECT_AGENTS_DIR = ".termcode/agents"
USER_AGENTS_DIR = "~/.termcode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("termcode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from termcode.agents.parser import parse_frontmatter, _validate_agent_meta
