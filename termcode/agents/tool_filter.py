...
def build_teammate_tools(
    ...
    from termcode.tools.send_message import SendMessageTool
    from termcode.tools.task_create import TaskCreateTool
    from termcode.tools.task_get import TaskGetTool
    from termcode.tools.task_list import TaskListTool
    from termcode.tools.task_update import TaskUpdateTool
